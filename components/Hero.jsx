    ...
    <section className="bg-slate-700 py-20 mb-4">
      ...
      >
        ...
        >
          ...
          <button
            type="submit"
            className="md:ml-4 mt-4 md:mt-0 w-full md:w-auto px-6 py-3 rounded-lg bg-slate-500 text-white hover:bg-slate-600 focus:outline-none focus:ring focus:ring-slate-500"
          >
            Search
          </button>
        </form>
